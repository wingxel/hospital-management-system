...
urlpatterns = [
    ...
    path('add_clinical_officer', add_clinical_officer, name = 'add_clinical_officer'),
    path('view_clinical_officer', view_clinical_officer, name = 'view_clinical_officer'),
    path('edit_clinical_officer/<int:officer_id>', edit_clinical_officer, name = 'edit_clinical_officer'),
